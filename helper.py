...
def medal_tally(df):
    medal_tally = df.drop_duplicates(subset=['Team', 'NOC', 'Year', 'Medal', 'Games', 'City', 'Event', 'Sport'])
...
def fetch_medal_tally(df,year,country):
    medal_df=df.drop_duplicates(subset=['Team','NOC','Year','Medal','Games','City','Event','Sport'])
    flag=0
